...
class QuestionsListFragment : BaseFragment(), QuestionsListViewMvc.Listener {
    ...
    override fun onEvenQuestionClicked(clickedQuestion: Question) {
        screensNavigator.toQuestionDetails(clickedQuestion.id)
    }

    override fun onOddQuestionClicked(clickedQuestion: Question) {
        screensNavigator.toQuestionDetailsViewModel(clickedQuestion.id)
    }
}